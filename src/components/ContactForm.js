        ...
        return (
            <Form onSubmit = {handleSubmit}>
                <Form.Group controlId = "contactFirstName">
                    ...
                    value={contactData.firstName} onChange={handleChange} isInvalid={!!contactErrors.firstName}/>
                ...
                <Form.Group controlId="contactLastName">
                    ...
                    value={contactData.lastName} onChange={handleChange} isInvalid={!!contactErrors.lastName}/>
                    <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="contactCompany">
                    ...
                    value={contactData.company} onChange={handleChange} isInvalid={!!contactErrors.company}/>
                    <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="contactEmail">
                    ...
                    value={contactData.email} onChange={handleChange} isInvalid={!!contactErrors.email}/>
                    <Form.Control.Feedback type="invalid">
                        {contactErrors.email}
                    </Form.Control.Feedback>
                    <Form.Text className={"text-muted"}>
